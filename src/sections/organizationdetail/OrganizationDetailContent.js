            ...
            {(openActive || toggleActive) && <ConfirmModal
                ...
                title={
                    <Typography
                        ...
                        {item.isActive ? "Tắt trạng thái hoạt động cho người dùng" : "Bật trạng thái hoạt động cho người dùng"}
                    </Typography>
                }
                subtitle={item.isActive ? "Bạn có chắc chắn muốn tắt hoạt động cho người dùng" : "Bạn có chắc chắn muốn bật hoạt động cho người dùng"}
                btnCancelProps={{
                    title: 'Huỷ',
                    sx: {
                        "&:hover": {
