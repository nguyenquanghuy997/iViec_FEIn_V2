...
export const RecruitmentApplicantCreate = ({
  ...
  useEffect(() => {
    ...
    setValue("activitiesAndProjects", preview.activitiesAndProjects ?? undefined);
    ...
    setValue("expectedWorkingAddress.address", preview.expectedWorkingAddress.address ?? undefined);
  }, [preview]);
