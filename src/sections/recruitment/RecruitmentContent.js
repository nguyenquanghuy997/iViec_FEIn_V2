...
function createData(name, organization, newsNumber, status, createdDate, createdBy) {
    return {name, organization, newsNumber, status, createdDate, createdBy};
}

const rows = [
    createData('Bước tuyển dụng 1', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 2', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 3', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 4', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 5', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 6', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 7', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 8', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 9', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 10', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 11', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
    createData('Bước tuyển dụng 12', 'Ứng tuyển > Thi tuyển', 1, 'Chờ nội bộ phê duyệt', '17/02/2023', 'Nguyễn Thị Thanh Huyền'),
];
...
const TABLE_HEAD = [
    ...
    {id: "newsNumber", label: "Số tin áp dụng", align: "right", numeric: true, minWidth: 160},
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCellStyle id={labelId} scope="row">{row.name}</TableCellStyle>
                                            ...
                                            <TableCellStyle align="center">{row.createdBy}</TableCellStyle>
                                        </TableRow>
                                    );
                                })
                            }
