...
const FormValidate = Yup.object().shape({
    ...
    candidateLevelId: Yup.string().nullable().required("Chức danh không được bỏ trống"),
    ...
    startDate: Yup.date().typeError("Ngày bắt đầu không đúng định dạng").required('Ngày bắt đầu không được bỏ trống'),
    endDate: Yup.date().typeError("Ngày kết thúc không đúng định dạng").min(Yup.ref('startDate'), "Ngày kết thúc phải lớn hơn ngày bắt đầu").required('Ngày kết thúc không được bỏ trống'),
    ...
    ownerId: Yup.string().nullable().required("Cán bộ tuyển dụng không được bỏ trống"),
    organizationPipelineId: Yup.string().nullable().required("Quy trình tuyển dụng không được bỏ trống"),
