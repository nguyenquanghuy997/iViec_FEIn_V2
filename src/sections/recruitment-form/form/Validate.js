...
const FormInformationCommonValidate = Yup.object().shape({
...
const FormInformationTimeValidate = Yup.object().shape({
...
const FormInformationSalaryValidate =Yup.object().shape({
...
const FormInformationDescriptionValidate = Yup.object().shape({
...
const FormInformationOwnerAndCouncilValidate = Yup.object().shape({
    ownerId: Yup.string().required("Cán bộ tuyển dụng không được bỏ trống"),
});


const FormInformationValidate = Yup.object().shape({
    name: Yup.string().required("Tiêu đề tin tuyển dụng không được bỏ trống").max(255, "Tiêu đề tin tuyển dụng tối đa 255 ký tự"),
    address: Yup.string().required("Địa điểm làm việc không được bỏ trống").max(255, "Địa điểm làm việc tối đa 255 ký tự"),
    recruitmentAddressIds: Yup.array().nullable().min(1, "Khu vực đăng tin không được bỏ trống").max(3, "Chọn tối đa 3 khu vực đăng tin"),
    candidateLevelId: Yup.string().required("Chức danh không được bỏ trống"),
...
const FormPipelineValidate = Yup.object().shape({
...
export {
    FormValidate,
    FormInformationValidate,
    FormPipelineValidate,
    // split
    FormInformationCommonValidate,
    FormInformationTimeValidate,
    FormInformationSalaryValidate,
    FormInformationDescriptionValidate,
    FormInformationOwnerAndCouncilValidate,
}