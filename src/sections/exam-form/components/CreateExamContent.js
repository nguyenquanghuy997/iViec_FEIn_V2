...
const CreateExamContent = () => {
	...
	return <>
			...
			<View ph={24}>
				...
				<View flexRow={true} mt={24}>
					...
					{renderExamSettingInfo(`<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
																	...
																	</svg>`, examSetting.isQuestionMixing == true ? 'Đảo vị trí câu hỏi' : 'Câu hỏi theo thứ tự')}
					{renderExamSettingInfo(`<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
																	...
																	</svg>`, examSetting.showType == 0 ? 'Hiển thị 1 câu hỏi trên một trang' : 'Hiển thị toàn bộ câu hỏi trên một trang')}
					{renderExamSettingInfo(`<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
																	...
																	</svg>`, examSetting.type == 0 ? 'Đề thi câu hỏi cố định' : 'Đề thi câu hỏi ngẫu nhiên')}
				</View>
			</View>
		...
		<ExamFormModal show={showForm} onClose={() => setShowForm(false)} onSubmit={handleSubmitForm} data={examSetting} />
		<ExamChooseTypeModal data={examSetting} show={showChooseType} onClose={() => setShowChooseType(false)} onSubmit={handleExamSetting} />
	</>
