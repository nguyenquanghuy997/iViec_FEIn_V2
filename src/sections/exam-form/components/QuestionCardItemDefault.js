...
function QuestionCardItemDefault({
  ...
  const handleOpenListImage = (data) => {
    setListImages(data?.questionFilePaths);
  ...
  return (
    <>
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                item.questionFilePaths?.length > 0 &&
                <ButtonIcon
                  onClick={() => handleOpenListImage(item)}
                  icon={<ImageIcon />}
                />
              }
            </CardFormItemTitleStyle>
      ...
      {
        openListImage &&
        <ListImageModal images={listImages} show={openListImage} onClose={() => { setOpenListImage(false) }} />
      }
