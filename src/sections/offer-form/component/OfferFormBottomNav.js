...
import { ActionSwitchCheckedIcon, ActionSwitchUnCheckedIcon, AlertIcon } from "@/sections/organization/component/Icon";
        ...
        subtitle={
          selectedList.length > 1 ? (
            <>
              ...
              className="subtitle-confirm-name">{selectedList.length} mẫu email</span> này??
            </>
          ) : (
            <>
