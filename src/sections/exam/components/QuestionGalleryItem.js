  ...
  const renderInfoItem = (icon, title, value) => {
    return (
      <>
        ...
        <Text ml={10} fontSize={14} fontWeight={"400"} color={theme.palette.common.neutral600}>
          {title}
        </Text>

        <Text ml={8} fontSize={14} fontWeight={"500"} color={theme.palette.common.neutral700}>
          {value}
        </Text>
      </>
    );
  ...
  return (
    ...
    >
      <View flexRow atStart>
        ...
        <View flex1 mh={12}>
          <Text fontSize={16} fontWeight={"600"} color={theme.palette.common.neutral800}>
            {name}
          </Text>
      ...
      <View flexRow atCenter mt={24}>
        ...
        {!quest.length && renderButtonAction(
          'Xóa',
