      ...
      <Stack flexDirection="row" alignItems="center" justifyContent='space-between' mb={4}>
        <Stack flexDirection="row" alignItems="center">
          ...
          <Stack sx={{ml: 2}}>
            ...
            <Typography sx={{fontSize: '12px', fontWeight: '400', color: theme.palette.common.neutral700}}>Để chỉnh sửa
              tên công ty, vui
              lòng
        ...
        <Stack flexDirection="row" alignItems="center">
          {
            (canViewUser || canViewUnit || canEditUser || canEditUnit || canApproveUser) &&
            <ButtonDS
              tittle={"Danh sách mời"}
              type="submit"
              sx={{
              ...
              icon={
                <img alt={""} width={16} height={16} style={{marginRight: "8px"}}
                     src={`/assets/icons/inbox-unarchive-line.svg`}/>
              }
          ...
          
          {
            ...
            <ButtonDS
              ...
              icon={
                <img alt={""} width={20} height={20} style={{marginRight: "8px"}}
