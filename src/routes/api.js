...
export const API_REGISTER =
  "/organization/Organization/CreateOrganizationWithUser";
...
export const API_FORGET_PASSWORD =
  "/identity/Identity/ApplicationUserForgetPassword";
export const API_USER_INVITE_SET_PASSWORD =
  "/identity/Identity/UserInvitedSetPassword";
export const API_CHANGE_PASSWORD = "/identity/Identity/ChangePassword";
export const API_CHANGE_PASSWORD_WITH_TOKEN =
  "/identity/Identity/ChangePasswordWithToken";
export const API_GET_APPLICATION_BY_ROLE_GROUP =
...
export const API_SET_ACTIVE_USER =
  "/identity/Identity/UpdateActiveApplicationUser";
...
export const API_SCAN_FILE_APPLICANTS =
  "/integrator/ConvertFile/UpLoadAndConvertFileCv"; // new lấy danh sách ứng viên
...
export const API_GET_RECRUITMENTS_BY_APPLICANT =
  "/applicant/ApplicantRecruitment/GetRecruitmentsByApplicant"; //lấy list tin tuyển dụng theo ứng viên và đơn vị
export const API_GET_APPLICANT_RECRUITMENT =
  "/applicant/ApplicantRecruitment/GetApplicantRecruitment"; //Lịch sử uv
export const API_GET_RECRUITMENT_PIPELINE_STATES_BY_RECRUITMENT =
  "/recruitment/Recruitment/GetRecruitmentPipelineStatesByRecruitment"; //List bước tuyển dụng
export const API_GET_APPLICANT_CURRENT_STAGE_WITH_RECRUITMENT_STATES =
  "/applicant/ApplicantRecruitment/GetApplicantCurrentStateWithRecruitmentStates"; //List pipeline và trạng thái UV theo TTD
export const API_UPDATE_APPLICANT_RECRUITMENT_TO_NEXT_STATE =
  "/applicant/ApplicantRecruitment/UpdateApplicantRecruitmentToNextState"; //Chuyển bước uv
export const API_UPLOAD_FILE_APPLICANT_RECRUITMENT =
  "/applicant/ApplicantRecruitment/UploadApplicantRecruitmentCv";
export const API_GET_APPLICANT_BY_PIPELINESTETEID =
...
export const API_GET_ORGANIZATION =
  "/organization/Organization/GetOrganization";
export const API_GET_ORGANIZATION_WITH_CHILD =
  "/organization/Organization/GetOrganizationsLessDataWithChild";
export const API_GET_ORGANIZATION_DETAIL_BY_ID =
  "/organization/Organization/GetOrganizationDetailById";
export const API_GET_ORGANIZATION_DETAIL_BY_SLUG =
  "/organization/Organization/GetOrganizationBySlug";
export const API_GET_ORGANIZATION_PREVIEW =
  "/organization/Organization/GetOrganizationPreview";
export const API_CREATE_CHILD_ORGANIZATION =
  "/organization/Organization/CreateChildOrganization";
export const API_UPDATE_ORGANIZATION =
  "/organization/Organization/UpdateOrganizationData";
export const API_DELETE_ORGANIZATION =
  "/organization/Organization/RemoveOrganizationById";
export const API_DELETE_MULTIPLE_ORGANIZATION =
  "/organization/Organization/RemoveOrganizations";
export const API_SET_ACTIVE_ORGANIZATION =
...
export const API_GET_LIST_USER_INVITE =
  "/organization/OrganizationUserInvite/GetOrganizationUserInvites";
export const API_DELETE_INVITE_USER =
  "/organization/OrganizationUserInvite/RemoveOrganizationUserInvite";
export const API_RESEND_INVITE_USER =
  "/organization/OrganizationUserInvite/ResendOrganizationUserInvite";
//Role
...
export const API_GET_COLUMN_ROLE =
  "/aggregator/OrganizationRoleVisible/GetOrganizationRoleVisible";
export const API_UPDATE_COLUMN_ROLE =
  "/aggregator/OrganizationRoleVisible/UpdateOrganizationRoleVisible";
export const API_SET_ACTIVE_ROLE_GROUP =
  "/identity/RoleGroup/SetRoleGroupsActive";

// Thông tin công ty
export const API_GET_COMPANY_INFOR =
  "organization/Organization/GetOrganization";
export const API_GET_COMPANY_INFOR_BY_IDS =
  "organization/Organization/GetOrganizationIds";
export const API_UPDATE_COMPANY_INFOR =
  "organization/OrganizationInformation/UpdateOrganizationInformation";
export const API_UPLOAD_IMAGE =
  "organization/Organization/OrganizationUploadImage";
export const API_UPDATE_ORGANIZATION_HUMAN =
  "/organization/OrganizationHuman/UpdateOrganizationHuman";
export const API_UPDATE_ORGANIZATION_BUSINESS =
  "organization/OrganizationBusiness/UpdateOrganizationBusiness";
export const API_UPDATE_ORGANIZATION_WORKING_ENVIRONMENT =
  "/organization/OrganizationWorkingEnvironment/UpdateOrganizationWorkingEnvironment";
export const API_UPDATE_ORGANIZATION_PIPELINE =
  "organization/OrganizationProfilePipeline/UpdateOrganizationProfilePipelines";
export const API_UPDATE_ORGANIZATION_ENDING =
  "organization/Organization/UpdateOrganization";
export const API_ADD_ORGANIZATION_BUSINESS =
  "organization/OrganizationBusiness/CreateOrganizationBusiness";
export const API_GET_ORGANIZATION_USERS =
  "/organization/Organization/GetApplicationUsersFilter";

// Mẫu đánh giá
export const API_GET_ALL_REVIEW_FORM =
  "/organization/ReviewForm/GetReviewForms";
export const API_GET_REVIEW_FORM_BY_ID =
  "/organization/ReviewForm/GetReviewForm";
export const API_UPDATE_STATUS_REVIEW_FORM =
  "/organization/ReviewForm/SetReviewFormsActive";
export const API_ADD_REVIEW_FORM = "/organization/ReviewForm/CreateReviewForm";
export const API_UPDATE_REVIEW_FORM =
  "/organization/ReviewForm/UpdateReviewForm";
export const API_DELETE_REVIEW_FORM =
  "/organization/ReviewForm/RemoveReviewForms";
...
export const API_GET_DETAIL_JOB_POSITION =
  "/recruitment/JobPosition/GetJobPosition"; //new
export const API_UPDATE_STATUS_JOBTYPE =
  "/recruitment/JobPosition/SetJobPositionsActivated";
...
export const API_GET_APPLICANT_USERS_ON_JOBTYPE =
  "/recruitment/JobPosition/GetApplicationUsersOnJobPosition";
export const API_GET_COLUMN_JOBTYPE =
  "/aggregator/OrganizationPositionVisible/GetOrganizationPositionVisible"; //new
export const API_UPDATE_COLUMN_JOBTYPE =
  "/aggregator/OrganizationPositionVisible/UpdateOrganizationPositionVisible"; //new

// Pipeline
export const API_GET_ALL_PIPELINE =
  "/organization/OrganizationPipeline/GetOrganizationPipelineFilter"; //new
export const API_GET_PIPELINE_BY_ID =
  "/organization/OrganizationPipeline/GetOrganizationPipeline";
export const API_GET_ALL_RECRUITMENT_STEP_PIPELINE =
  "/organization/OrganizationPipeline/GetOrganizationPipeline";
export const API_GET_ALL_PIPELINE_BY_ORGANIZATION =
  "/organization/OrganizationPipeline/GetOrganizationPipelineByOrganization"; //new
export const API_SET_ORGANIZATION_PIPELINE_ACTIVE =
  "/organization/OrganizationPipeline/SetOrganizationPipelinesActive"; // bật tắt trạng thái hoạt động
export const API_ADD_PIPELINE =
  "organization/OrganizationPipeline/CreateOrganizationPipeline"; //new
export const API_UPDATE_PIPELINE =
  "organization/OrganizationPipeline/UpdateOrganizationPipeline"; //new
export const API_DELETE_PIPELINE =
  "organization/OrganizationPipeline/RemoveOrganizationPipelines"; //new
export const API_GET_COLUMN_PIPELINE =
  "aggregator/RecruitmentProcessingVisible/GetRecruitmentProcessingVisible"; //cột
export const API_UPDATE_COLUMN_PIPELINE =
  "aggregator/RecruitmentProcessingVisible/UpdateRecruitmentProcessingVisible"; //update cột

// API Application page
// recruitment tin tuyển dụng
export const API_GET_RECRUITMENT_BY_ID =
  "/recruitment/Recruitment/GetRecruitment"; // get recruitment by id
export const API_GET_RECRUITMENT_BY_SLUG =
  "/recruitment/Recruitment/GetRecruitmentBySlug"; // get recruitment by slug
export const API_GET_LIST_RECRUITMENT =
  "/recruitment/Recruitment/GetRecruitments"; // get all recruitment
export const API_GET_RECRUITMENT_BY_ORGANIZATION =
  "/recruitment/Recruitment/GetRecruitmentByOrganizationId"; // new - get recruitment by organization
export const API_CREATE_RECRUITMENT =
  "/recruitment/Recruitment/CreateRecruitment"; // new - create recruitment
export const API_UPDATE_RECRUITMENT =
  "/recruitment/Recruitment/UpdateRecruitment"; // new - update recruitment official
export const API_UPDATE_RECRUITMENT_DRAFT =
  "/recruitment/Recruitment/SetRecruitmentDraftOrOfficial"; // new - update recruitment draft
export const API_CREATE_APPLICANT_RECRUITMENT =
  "/applicant/ApplicantRecruitment/CreateApplicantRecruitment";
export const API_GET_COLUMN_RECRUITMENT =
  "/aggregator/RecruitmentVisible/GetRecruitmentVisible";
export const API_UPDATE_COLUMN_RECRUITMENT =
  "/aggregator/RecruitmentVisible/UpdateARecruitmentVisible";
export const API_GET_RECRUITMENT_PERSON_IN_CHARGE_IDS =
  "/recruitment/Recruitment/GetRecruitmentPersonInChargeIds";

// duyệt tin
export const API_GET_INTERNAL_GET_WAITING_APPROVAL_RECRUITMANT =
  "/recruitment/Recruitment/InternalGetWaitingApprovalRecruitments"; // list tin cần iviec duyệt
export const API_INTERNAL_APPROVAL_RECRUITMANT =
  "/recruitment/Recruitment/InternalApprovalRecruitments"; // phê duyệt nhiều tin
export const API_REJECT_RECRUITMENT =
  "/recruitment/Recruitment/RejectRecruitment"; // phê duyệt nhiều tin
export const API_CLOSE_RECRUITMENT =
  "/recruitment/Recruitment/CloseRecruitments"; // đóng nhiều tin tuyển dụng
export const API_REMOVE_RECRUITMENT =
  "/recruitment/Recruitment/RemoveRecruitments"; // xóa nhiều tin tuyển dụng

// get user from organization
export const API_GET_USER_FROM_ORGANIZATION =
  "/organization/Organization/GetApplicationUserByOrganization";
export const API_GET_ADD_APPLICANT_TO_RECRUITMENT =
...
export const API_CREATE_APPROVE_PROCESS =
  "/organization/ApprovalProcess/CreateApprovalProcess";
export const API_UPDATE_APPROVE_PROCESS =
  "/organization/ApprovalProcess/UpdateApprovalProcess";
export const API_SET_AVAILABLE_APPROVE_PROCESS =
  "/organization/ApprovalProcess/SetApprovalProcessAvailable";
export const API_DELETE_APPROVE_PROCESS =
  "/organization/ApprovalProcess/RemoveApprovalProcess";
export const API_GET_APPROVE_PROCESSES =
  "/organization/ApprovalProcess/GetApprovalProcesses";
export const API_GET_APPROVE_PROCESS =
  "/organization/ApprovalProcess/GetApprovalProcess";

// API master data
export const API_GET_LIST_CANDIDATELEVEL =
  "/masterData/CandidateLevel/GetCandidateLevels";
...
export const API_GET_JOB_CATEGORIES =
...
export const API_CANCEL_BOOKING_CALENDAR =
  "/applicant/BookingCalendar/CancelBookingCalendar";
// Thi tuyển
...
export const API_CREATE_QUESTION_GROUP =
  "/examination/QuestionGroup/CreateQuestionGroup";
export const API_UPDATE_QUESTION_GROUP =
  "/examination/QuestionGroup/UpdateQuestionGroup";
...
export const API_CREATE_QUESTION = "/applicant/Question/CreateQuestion";
export const API_UPDATE_QUESTION = "/applicant/Question/UpdateQuestion";
export const API_GET_QUESTION_VISIBLE =
