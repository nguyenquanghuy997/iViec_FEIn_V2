...
ScheduleOnline.getLayout = function getLayout({roles = []}, page) {
  return (
...
function ScheduleOnline() {
  ...
  return (
      <Page title="Email lịch phỏng vấn trực tuyến">
        <Box>
          <FormHeader
        ...
        {toggleFormModal && <FormModal
            ...
            item={item}
            title={item?.id ? 'Chỉnh sửa mẫu email lịch phỏng vấn trực tuyến' : 'Thêm mới mẫu email lịch phỏng vấn trực tuyến'}
        />}
      </Page>
  )
}
